...
api.interceptors.response.use(
  ...
  (err) => {
    ...
    // 403 → show toast, NOT a logout (Moderator hits 403 on mutation endpoints)
...
export const adminApi = {
  ...
  dashboardActivitySummary: (days = 7) => api.get(`/admin/dashboard/activity-summary?days=${days}`),
